...
@section('body')
    ...
    <div class="row my-filter hidden-xs">
        <div class="col-md-5 col-sm-6  city-btn">
        ...
        <div class="col-md-4 col-sm-6 prize-search">
    ...
    <div class="row my-filter hidden-sm hidden-lg hidden-md">
    ...
    <div class="row my-filter hidden-sm hidden-lg hidden-md">
        <div class="text-center  city-btn">
